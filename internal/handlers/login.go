...
// Handle posting to login
func (m *Repository) PostLogin1(w http.ResponseWriter, r *http.Request) {
	...
	// Get db repo
	// TODO: This will get removed later on
	repo := dbrepo.NewSqliteRepo( /* m.App */ &config.DBControllerConfig{}, uEmail, dbconn.SQL)
